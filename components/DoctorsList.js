...
const DoctorsList = () => {
  ...
  const handlePress = () => {
    ...
    navigation.navigate("doctor-details"); // Replace 'Details' with the name of your details screen
  };
  ...
  const renderDoctorCard = ({ item }) => (
    <View style={styles.doctorCard}>
      ...
      <TouchableOpacity onPress={handlePress} style={styles.learnMoreButton}>
